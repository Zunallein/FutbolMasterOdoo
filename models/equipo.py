...
class Equipo(models.Model):
    ...
    entrenador = fields.Many2one("futbol_master.entrenador", string="Entrenador", required=True)
    jugadores = fields.Many2many("futbol_master.jugador", string="Jugadores", required=True)
